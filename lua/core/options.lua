...
vim.o.foldmethod = "expr" -- use `foldexpr` for calculating folds
vim.o.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- set function for calculating folds
...
vim.o.sessionoptions = "buffers,curdir,folds,help,tabpages,winsize,winpos,terminal" -- things to save for sessions
